...
//  if (strcmp(  "bz0",name)==0) return &(ff->bz0);
  if (strcmp("tmpkx",name)==0) return &(ff->tmpkx);
  if (strcmp("tmpky",name)==0) return &(ff->tmpky);
  if (strcmp("tmpkz",name)==0) return &(ff->tmpkz);
...
//    case 10: return &(ff->bz0);
    case  8: return &(ff->tmpkx);
    case  9: return &(ff->tmpky);
    case 10: return &(ff->tmpkz);
